...
class Pirate:
    def __init__(self, map, treasure_loc, turn_escape):
        self.map = map
        self.current_loc = (32, 32) #self.initialize_location()
    ...
    def astar(self):
        ...
        open_set.put((0, cnt, self.current_loc))
        came_from = {}
        g_score = {}
        g_score[self.current_loc] = 0
        f_score = {}
        f_score[self.current_loc] = self.h(self.current_loc, self.treasure_loc)
